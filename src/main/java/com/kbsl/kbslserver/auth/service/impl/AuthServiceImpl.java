package com.kbsl.kbslserver.auth.service.impl;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.gson.Gson;
import com.kbsl.kbslserver.auth.domain.model.AuthToken;
import com.kbsl.kbslserver.auth.domain.repository.AuthTokenRepository;
import com.kbsl.kbslserver.auth.domain.repository.RoleRepository;
...
import com.kbsl.kbslserver.auth.dto.response.OauthTokenResponse;
import com.kbsl.kbslserver.auth.enums.ERole;
import com.kbsl.kbslserver.auth.oauth.OAuthUserInfo;
import com.kbsl.kbslserver.auth.oauth.provider.DiscordUserInfo;
import com.kbsl.kbslserver.auth.service.AuthService;
...
public class AuthServiceImpl implements AuthService {
    ...
    private Authentication getOAuthUserInfo(String providerName, OauthTokenResponse oauthTokenResponse, ClientRegistration provider) {
        ...
        log.info("oauth.getNickname {}", oAuthUserInfo.getNickname());
        ...
        UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken = new UsernamePasswordAuthenticationToken(nickname, password);
